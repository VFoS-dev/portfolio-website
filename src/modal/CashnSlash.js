        ...
        return (
            <Fragment>
                <center style={{ margin: "4% 0px", padding: '0px 15%' }}>
                    ...
                    <video style={{ width: '100%', height: 'auto' }} controls><source src="/images/projects/info/vrKeyboard.mp4" type="video/mp4" /></video>
                    <br /><br />
                    ...
                    <video style={{ width: '100%', height: 'auto' }} controls><source src="/images/projects/info/moneyPhysics.mp4" type="video/mp4" /></video>
                    <br /><br />
                    <h1>Cash Textures</h1>
                    <br />
                    <p>These were the availiable textures I applied to the the particle-based models.</p>
                    <img src="/images/projects/info/cashTextures.png" width="100%" />
                    <br /><br />
                    <h1>Cash Physics</h1>
                    <br />
                    ...
                    <img src="/images/projects/info/cashGravity.gif" width="100%" />
                    <br /><br />
                    ...
                    <img src="/images/projects/info/cafe.gif" width="100%" />
                </center>
            </Fragment>
        );
    }
