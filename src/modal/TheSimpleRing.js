        ...
        return (
            <Fragment>
                <center style={{ margin: "4% 0px", padding: '0px 15%' }}>
                    ...
                    <p>This project was made for <a href='https://thesimplering.com' rel="noreferrer" target="_blank">The Simple Ring</a> Company. I worked as an independant contractor
                    ...
                    <h5><a href='https://ringtesting.jonathankido.com' rel="noreferrer" target="_blank">Website Demo</a> made with: Unity WebGL, C#, React, Javascript, Firebase</h5>
                </center>
            </Fragment>
        );
    }
