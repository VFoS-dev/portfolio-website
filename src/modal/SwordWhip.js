        ...
        return (
            <Fragment>
                <center style={{ position: 'relative', margin: "4% 0px", padding: '0px 15%' }}>
                    ...
                    <video className='video' controls><source src="/images/projects/info/swordwhip.mp4" type="video/mp4" /></video>
                    <br />
                    ...
                    <div style={{ display: 'flex', flexDirection: 'row', justifyContent: 'space-between', flexWrap: 'wrap' }}>
                        <img src='/images/projects/info/swordwhip1.png' alt='' />
                        <img src='/images/projects/info/swordwhip2.png' alt='' />
                    </div>
                </center>
            </Fragment>
        );
