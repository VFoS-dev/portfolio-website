        ...
        return (
            <Fragment>
                <center style={{ margin: "4% 0px", padding: '0px 15%' }}>
                    ...
                    <iframe width="100%" height={`${clientWidth * 0.554 * 0.5625}px`} src="https://www.youtube.com/embed/3NAEDSFhHhU" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                    <br />
